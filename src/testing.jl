...
function palindrome_X(G::FiniteCoxeterGroup,genus::Number,puncture_min::Number,puncture_max::Number)
...
function euler_X(G::FiniteCoxeterGroup,genus::Number,puncture_min::Number,puncture_max::Number)
...
function nonnegative_Y(G::FiniteCoxeterGroup,genus::Number,puncture_min::Number,puncture_max::Number)
...
function nonnegative_X(G::FiniteCoxeterGroup,genus::Number,puncture_min::Number,puncture_max::Number)
...
function log_nonnegative_Y(G::FiniteCoxeterGroup,genus::Number,puncture_min::Number,puncture_max::Number)
	# Checks negativity of coefficients of E(Y;q) with g=genus and n=puncture_min,...,puncture_max
	...
	for n in puncture_min:puncture_max
		try 
			if isnonnegative(fast_EY(G,genus,n,d))
				@info("Coefficients all non-negative when n=$n")
			else
				@info("Negative coefficients found when n=$n")
			end
		catch err 
			println("$err")
		end
...
function check_dim_X(G::FiniteCoxeterGroup,genus_min::Number,genus_max::Number,puncture_min::Number,puncture_max::Number)
	d=group_type_data(G)
	for n in puncture_min:puncture_max
...
function check_dim_Y(G::FiniteCoxeterGroup,genus_min::Number,genus_max::Number,puncture_min::Number,puncture_max::Number)
	d=algebra_type_data(G)
	for n in puncture_min:puncture_max
		for g in genus_min:genus_max
